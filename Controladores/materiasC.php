		...
		if(isset($_POST["Cid"])){
			...
			if($_FILES["programa"]["type"] == "application/pdf"){
				...
				if($resultado == true){
					...
					window.location = "https://app.emunah.edu.co/Crear-Materias/'.$Cid.'";
					</script>';
	...
	public function CrearComisionC(){
		...
		if(isset($_POST["id_materia"])){
			...
			if($resultado == true){
					...
					window.location = "https://app.emunah.edu.co/Crear-Comisiones/'.$id_materia.'";
					</script>';
		...
		if(isset($_GET["Mid"])){
			...
			if($resultado == true){
				...
				echo '<script>
					...
					window.location = "https://app.emunah.edu.co/Crear-Comisiones/'.$Mid.'";
					</script>';
		...
		if(isset($_POST["id_alumno"])){
			...
			if($resultado == true){
				...
				echo '<script>
					...
					window.location = "https://app.emunah.edu.co/Ver-Plan/'.$id_carrera.'/'.$libreta.'";
					</script>';
		...
		if(isset($_POST["id_alumno"])){
			...
			if($resultado == true){
				...
				echo '<script>
					...
					window.location = "https://app.emunah.edu.co/Materias";
					</script>';
		...
		if(isset($_POST["E"])){
			...
			if($resultado == true){
				...
				echo '<script>
					...
					window.location = "https://app.emunah.edu.co/Carreras";
					</script>';
