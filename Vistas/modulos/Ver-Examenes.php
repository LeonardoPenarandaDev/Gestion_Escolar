							...
							if($value["id_carrera"] == $exp[1]){
								...
								if($_SESSION["rol"] == "Estudiante" && $value["estado"] == 1){
									...
									echo '<td>
										...
										echo '<a href="https://app.emunah.edu.co/insc-examen/'.$_SESSION["id_carrera"].'/'.$value["id"].'">
									...
									echo '<td>
										...
										echo '<a href="http://localhost/app2.0/instituto/Inscriptos-examen/'.$value["id"].'">
										...
										<button class="btn btn-primary">Ver Inscriptos</button>
											...
											if($value["estado"] == 1){
												...
												echo '<a href="https://app.emunah.edu.co/">
