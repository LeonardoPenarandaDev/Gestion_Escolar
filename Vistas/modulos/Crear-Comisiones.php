	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-body">
				...
				echo '<h2>Grupos de la Materia:</h2>
				...
				<div class="row">
					...
					<div class="col-md-12 col-xs-12">
						...
						<button class="btn btn-primary btn-md" data-toggle="modal" data-target="#CrearComision">Crear Grupo</button>
								...
								foreach ($comisiones as $key => $value) {
									...
									echo '<tr>
											...
											<td>
												...
												<a href="https://app.emunah.edu.co/tcpdf/pdf/Inscriptos-Materia.php/'.$exp[1].'/'.$value["id"].'" target="blank">
												...
												<button class="btn btn-danger BorrarComision" Cid="'.$value["id"].'" Mid="'.$exp[1].'">Borrar Grupo</button>
