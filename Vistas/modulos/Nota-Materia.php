...
foreach ($nota as $key => $EN) {
	...
	if($EN["id_materia"] == $exp[3] && $EN["libreta"] == $exp[2]){
		...
		window.location = "https://app.emunah.edu.co/Editar-Nota/'.$exp[3].'/'.$exp[2].'/'.$EN["id"].'"
		</script>';
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<form method="post">
					...
					echo '<h2>Alumno: '.$estudiante["apellido"].' '.$estudiante["nombre"].' - Usuario: '.$estudiante["libreta"].'</h2>';
