...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<h1>Gestor de Ciclos y Cursos</h1>
	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header">
				...
				<button class="btn btn-danger pull-right" type="submit" data-toggle="modal" data-target="#VaciasRegistrosMaterias">Vaciar registros de Inscripciones a las Materias</button>
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<h2>Esta seguro que desea habilitar las inscripciones a las materias??</h2>
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<h2>Esta seguro que desea Deshabilitar las inscripciones a las materias??</h2>
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<h2>Esta seguro que desea Eliminar Todas las inscripciones a las materias??</h2>
